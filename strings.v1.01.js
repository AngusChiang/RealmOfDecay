...
Game.SKILL_LIST = [
  ...
  ["Shield Crush (NYI)","Adds a 2% chance per rank to ignore enemy armour bonus against your weapon when attacking.",10312],
...
Game.BADGE_LIST = [
  ...
  ["Unlimited Power!","Spend 100 Power points.","OK, so 100 isn't unlimited, so what! It sounded cool, okay?",2037],
  ["Indecisive","Reset your stats or powers a total of 100 times.","I used to be indecisive, but now I'm not so sure.",2038],
