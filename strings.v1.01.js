...
Game.SKILL_LIST = [["Proper Care","Grants a 2% chance per level to ignore armour/weapon decay in combat.",101],
                  ...
                  ["Undermine","When using Burst Attack, the enemy's resistance to your attack type is treated as a vulnerability.",1123],
...
Game.BADGE_LIST = [
  ...
  ["Master of Subterfuge","Attain maximum rank in the 'Undermine' power.","Breaking through their defences is so much easier from the inside.",2054],
