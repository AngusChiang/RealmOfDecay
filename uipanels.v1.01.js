...
Game.createStatPointPanel = function () {
  ...
  strAdd1Button.onclick = function (a, b) {
    return function () {
      Game.addStat(a, b);
    };
  }(Game.STAT_STR, 1);
  ...
  strAdd10Button.onclick = function (a, b) {
    return function () {
      Game.addStat(a, b);
    };
  }(Game.STAT_STR, 10);
  ...
  dexAdd1Button.onclick = function (a, b) {
    return function () {
      Game.addStat(a, b);
    };
  }(Game.STAT_DEX, 1);
  ...
  dexAdd10Button.onclick = function (a, b) {
    return function () {
      Game.addStat(a, b);
    };
  }(Game.STAT_DEX, 10);
  ...
  intAdd1Button.onclick = function (a, b) {
    return function () {
      Game.addStat(a, b);
    };
  }(Game.STAT_INT, 1);
  ...
  intAdd10Button.onclick = function (a, b) {
    return function () {
      Game.addStat(a, b);
    };
  }(Game.STAT_INT, 10);
  ...
  conAdd1Button.onclick = function (a, b) {
    return function () {
      Game.addStat(a, b);
    };
  }(Game.STAT_CON, 1);
  ...
  conAdd10Button.onclick = function (a, b) {
    return function () {
      Game.addStat(a, b);
    };
  }(Game.STAT_CON, 10);
